...
import { registerUser } from '../../../_utils/authApi';
    ...
    <div className="container px-6 py-24 mx-auto lg:py-32">
        <div className="lg:flex">
            <div className="lg:w-1/2">
                ...
                <h1 className="mt-4 text-gray-600 dark:text-gray-300 md:text-lg">Create your account</h1>
      ...
      <div className="relative mt-4">
        <label htmlFor="role" className="block text-gray-700 dark:text-gray-300">
          Role
        </label>
        <select
          id="role"
