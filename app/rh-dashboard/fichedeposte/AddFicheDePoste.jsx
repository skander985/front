...
//           <input
//             type="text"
//             value={activitesEtTaches[0]}
//             onChange={(e) => {
//               const newActivites = [...activitesEtTaches];
//               newActivites[0] = e.target.value;
//               setActivitesEtTaches(newActivites);
//             }}
//             className="mt-1 p-2 border border-gray-300 rounded w-full"
//           />
//           {/* Add functionality to add more fields if needed */}
//         </div>
//         {/* Repeat for other fields (competencesTechniques, aptitudesProfessionnelles, etc.) */}
//         <button
//           type="submit"
...
//   const navigate = useNavigate();
//   const responsableId = localStorage.getItem('rhId');
